...
///////////////////////////////////////
const 스피너랜더해줘 = function(parentEl) {
    const 마크업 = `
  <div class="spinner">
          <svg>
    ...
    parentEl.innerHTML = "";
    parentEl.insertAdjacentHTML("afterbegin", 마크업);
};
const 레시피보여줘 = async function() {
    try {
        // 1) 레시피 로딩
        스피너랜더해줘(recipeContainer);
        ...
        const 마크업 = `
            ...
            <img src="${레시피.Image}" alt="${레시피.title}" class="recipe__img" />
          ...
          <div class="recipe__details">
            <div class="recipe__info">
              ...
              <span class="recipe__info-data recipe__info-data--minutes">${레시피.cookingTime}</span>
            ...
            <div class="recipe__info">
              ...
              <span class="recipe__info-data recipe__info-data--people">${레시피.servings}</span>
          ...
          <div class="recipe__ingredients">
            ...
            ${레시피.ingredients.map((재료)=>{
            return ` <li class="recipe__ingredient">
                <svg class="recipe__icon">
                  <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
                </svg>
                <div class="recipe__quantity">${재료.quantity}</div>
                <div class="recipe__description">
                  <span class="recipe__unit">${재료.unit}</span>
                  ${재료.description}
                </div>
              </li>`;
        }).join("")}
          ...
          <div class="recipe__directions">
            ...
            <p class="recipe__directions-text">
              ...
              <span class="recipe__publisher">${레시피.publisher}</span>. Please check out
        ...
        recipeContainer.insertAdjacentHTML("afterbegin", 마크업);
    } catch (err) {
        alert(err);
    }
};
